- `android`: `afc3dd03255b` 
- `art`: `` 
- `bionic`: `5e704b240138` 
- `bootable/deprecated-ota`: `06e32ab2c09f` 
- `bootable/libbootloader`: `4b27e19e636e` 
- `bootable/recovery`: `c9d9b516af2b` 
- `build/blueprint`: `7d7349a68b8e` 
- `build/make`: `083aa4a4442d` 
- `build/pesto`: `8e06db55f0ea` 
- `build/release`: `` 
- `build/soong`: `cff28f536f96` 
- `cicd`: `8279389018fd` (Dirty, Untracked: `changelog-generator/changelog.json`, `changelog-generator/changes`, `changelog-generator/changes.md`, `changelog-generator/out`, `changelog-generator/snapshot`, `jsconfig.json`, `justfile`, `package.json`, `status.after`, `status.before`, `target/`)
- `cts`: `9b8d03302b88` 
- `dalvik`: `be1c5a73925a` 
...
- `device/lineage/sepolicy`: `c0a6ee1e8aff` 
- `device/qcom/sepolicy`: `84e7b7b4accf` 
- `device/qcom/sepolicy-legacy-um`: `b28a32c46c67` 
- `device/qcom/sepolicy_vndr/legacy-um`: `ac205a3f1585` (Dirty, Modified: `qva/vendor/common/init.te`)
- `device/qcom/sepolicy_vndr/sm8450`: `3cf5bcbc1052` 
- `device/qcom/sepolicy_vndr/sm8550`: `c2a16e970877` 
- `device/qcom/sepolicy_vndr/sm8650`: `2c83259538a5` 
- `device/qcom/sepolicy_vndr/sm8750`: `dd8ebd72c21d` 
- `device/sample`: `172545c4d589` 
- `device/xiaomi/lmi`: `6efad5a890a2` 
- `device/xiaomi/miuicamera-mondrian`: `7cdf95765b26` 
- `device/xiaomi/mondrian`: `0377ab689255` (Dirty, Untracked: `proprietary-firmware.txt.bak`)
- `device/xiaomi/sm8250-common`: `1f60b5ddd2de` 
- `device/xiaomi/sm8450-common`: `c7db096a98a4` (Dirty, Modified: `extract-files.py`, `proprietary-files.txt`)
...
- `external/OpenCL-ICD-Loader`: `a1ec960d6dca` 
...
- `external/automotive-design-compose-protos`: `` 
...
- `external/chromium-web-tests`: `` 
- `external/chromium-webview/patches`: `5cb676d43f55` 
- `external/chromium-webview/prebuilt/arm`: `6f94e76a960a` 
- `external/chromium-webview/prebuilt/arm64`: `70d1609c9034` 
- `external/chromium-webview/prebuilt/x86`: `84c74ff7aeda` 
- `external/chromium-webview/prebuilt/x86_64`: `69244c67f5fb` 
...
- `external/freetype`: `275b4ecccecf` 
...
- `external/google-fonts/google-sans-flex`: `` 
...
- `external/jackson-core`: `29ae4cbc6bb2` 
...
- `external/mockito-kotlin`: `7e265442c36c` 
...
- `external/python/cpplint`: `` 
- `external/python/cpython3`: `2c4a4712b107` 
...
- `external/python/pexpect`: `` 
- `external/python/portpicker`: `864c91de0c09` 
- `external/python/ptyprocess`: `` 
...
- `external/python/snippet-uiautomator`: `` 
...
- `external/rust/ninja-to-soong`: `` 
- `external/rust/pica`: `2412922255f5` 
- `external/rust/rutabaga_gfx`: `` 
...
- `external/sg3_utils`: `ea5ccea9f423` 
...
- `external/tailscale`: `96bc1eec795f` 
- `external/tailscale/prebuilt`: `d79e3b67e2ae` 
...
- `hardware/interfaces`: `2e4a41b1d9a5` 
- `hardware/knowles/athletico/sound_trigger_hal`: `fcbd955ac3fe` 
- `hardware/libhardware`: `d8e910cf86e4` 
- `hardware/libhardware_legacy`: `bbd89a5b48ce` 
- `hardware/lineage/compat`: `b7992333fe7e` 
- `hardware/lineage/interfaces`: `1b3557daa0d3` 
...
- `hardware/qcom-caf/common`: `95c5d93690cd` 
...
- `hardware/qcom-caf/sm8350/audio`: `6afc6e6245e6` 
...
- `hardware/qcom-caf/sm8450/audio/pal`: `0ab95e9be6aa` 
- `hardware/qcom-caf/sm8450/audio/primary-hal`: `0b70a90c0bd7` 
...
- `hardware/qcom-caf/sm8750/audio/agm`: `d6fba18b47dd` 
- `hardware/qcom-caf/sm8750/audio/graphservices`: `62591b81ddb1` 
- `hardware/qcom-caf/sm8750/audio/pal`: `02956690e276` 
- `hardware/qcom-caf/sm8750/audio/primary-hal`: `f60ec59443db` 
- `hardware/qcom-caf/sm8750/data-ipa-cfg-mgr`: `f5a3d99b59d7` 
- `hardware/qcom-caf/sm8750/dataipa`: `845bfb986bcb` 
- `hardware/qcom-caf/sm8750/display/core`: `5c18ca2afe7c` 
- `hardware/qcom-caf/sm8750/display/hal`: `572019cf2315` 
- `hardware/qcom-caf/sm8750/display/intf`: `19b5c055b40b` 
- `hardware/qcom-caf/thermal`: `a4298a2b60e3` 
- `hardware/qcom-caf/thermal-legacy-um`: `74bce7c7382f` 
- `hardware/qcom-caf/wlan`: `7aa5591c582d` 
...
- `kernel/xiaomi/sm8250`: `d401417d0c45` 
- `kernel/xiaomi/sm8450`: `2972e1ff3b1b` 
- `kernel/xiaomi/sm8450-devicetrees`: `71accbf6ec3c` 
- `kernel/xiaomi/sm8450-modules`: `d7a080f0731e` 
- `libcore`: `080fac8bb867` 
- `libnativehelper`: `7439fa5c451c` 
- `lineage-sdk`: `60d0477f66f4` 
- `lineage/charter`: `873eada46943` 
- `lineage/contributors-cloud-generator`: `b4f0e2854ae4` 
- `lineage/crowdin`: `70783f1bed1b` 
- `lineage/hudson`: `52ba84f0fa7d` 
- `lineage/mirror`: `fc03fddff63f` 
- `lineage/scripts`: `e1726c452ff7` 
- `lineage/website`: `18f1b58272a7` 
- `lineage/wiki`: `7772f42023a0` 
- `ota`: `6166917aa935` 
- `packages/apps/Aperture`: `825b7f6fb921` 
...
- `packages/apps/Car/Cluster`: `c8102f973ce2` 
...
- `packages/apps/DeskClock`: `8987c256ccea` 
...
- `packages/apps/Settings`: `f08363f4549c` 
- `packages/apps/SettingsIntelligence`: `cc1a49f27a19` 
- `packages/apps/SetupWizard`: `d470698baff6` 
...
- `packages/apps/Twelve`: `6b0152dfdcb6` 
- `packages/apps/UniversalMediaPlayer`: `bb9dccc92f32` 
- `packages/apps/Updater`: `4150e2f3f3b9` 
- `packages/apps/WallpaperPicker2`: `332100aba321` 
- `packages/inputmethods/LatinIME`: `5253c60f1078` 
...
- `packages/resources/devicesettings`: `15f32219b74a` 
...
- `packages/services/QualifiedNetworksService`: `` 
...
- `patches`: `fd026d1a8a4f` (Dirty, Modified: `23/system/sepolicy/0001-Neutralize-sepolicy-freeze-test.patch`)
- `pdk`: `ad73c9600d6f` 
...
- `prebuilts/module_sdk/ConfigInfrastructure`: `d9e8529c14b2` 
...
- `prebuilts/module_sdk/Telephony`: `` 
...
- `system/sepolicy`: `07792ae5ed7b` (Dirty, Modified: `tests/policy.py`, `tests/sepolicy_tests.py`)
...
- `tools/external_updater`: `d4cc1f49febb` 
- `tools/extract-utils`: `4bbc4b9c058c` 
- `tools/lint_checks`: `` 
...
- `vendor/apn`: `57330956c9fc` 
- `vendor/codeaurora/telephony`: `522eeb16de33` 
- `vendor/crowdin`: `93da2a701076` 
- `vendor/extra`: `3b1ab387c053` 
- `vendor/lineage`: `60444c0dcd11` 
- `vendor/partner_gms`: `cd6584ad6443` (Dirty, Untracked: `FakeStore/FakeStore.apk`, `GmsCore/GmsCore.apk`)
- `vendor/pfa`: `e6b9e83b85f6` (Dirty, Modified: `pfa-init/Android.bp`, `shell-selector/Android.bp`)
...
- `vendor/qcom/opensource/commonsys-intf/display`: `7cbc3cb7b057` 
...
- `vendor/xiaomi/mondrian`: `a763ca66b558` 
- `vendor/xiaomi/sm8250-common`: `8e68dad400c2` 
- `vendor/xiaomi/sm8450-common`: `a37602e5b737` (Dirty, Modified: `Android.bp`, `proprietary/system_ext/lib64/libwfdnative.so`, `proprietary/system_ext/lib64/vendor.qti.hardware.qccsyshal@1.2-halimpl.so`, `proprietary/vendor/lib64/libdpps.so`)
