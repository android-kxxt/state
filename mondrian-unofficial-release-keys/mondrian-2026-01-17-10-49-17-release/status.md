...
- `cicd`: `8279389018fd` (Dirty, Modified: `sign.sh`, Untracked: `changelog-generator/changelog.json`, `changelog-generator/changes`, `changelog-generator/changes.md`, `changelog-generator/out`, `changelog-generator/snapshot`, `jsconfig.json`, `justfile`, `package.json`, `status.after`, `status.before`, `target/`)
- `cts`: `9b8d03302b88` 
- `dalvik`: `be1c5a73925a` 
...
- `vendor/xiaomi/sm8450-common`: `a37602e5b737` (Dirty, Modified: `Android.bp`, `proprietary/system_ext/lib64/libwfdnative.so`, `proprietary/system_ext/lib64/vendor.qti.hardware.qccsyshal@1.2-halimpl.so`)
